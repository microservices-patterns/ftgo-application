...
org.springframework.cloud.contract.spec.Contract.make {
    ...
    input {
        ...
        messageHeaders {
            header('command_type','net.chrisrichardson.ftgo.restaurantorderservice.api.CreateTicket')
    ...
    outputMessage {
        ...
        headers {
            header('reply_type', 'net.chrisrichardson.ftgo.restaurantorderservice.api.CreateTicketReply')
