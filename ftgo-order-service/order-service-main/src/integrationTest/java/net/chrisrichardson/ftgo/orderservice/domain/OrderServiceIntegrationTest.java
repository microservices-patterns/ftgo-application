...
public class OrderServiceIntegrationTest {
  ...
  public void shouldCreateOrder() {
    domainEventPublisher.publish("net.chrisrichardson.ftgo.restaurantservice.domain.Restaurant", RESTAURANT_ID,
            Collections.singletonList(makeAjantaRestaurantCreatedEvent()));
  ...
  private Predicate<Message> forConsumer(long consumerId) {
    return (m) -> {
      ...
      return Long.valueOf(consumerId).equals(s);
    };
  }
  ...
  private RestaurantCreated makeAjantaRestaurantCreatedEvent() {
    RestaurantMenu menu = new RestaurantMenu(Collections.singletonList(
        new MenuItem(RestaurantMother.CHICKEN_VINDALOO_MENU_ITEM_ID, RestaurantMother.CHICKEN_VINDALOO, RestaurantMother.CHICKEN_VINDALOO_PRICE)));
    return new RestaurantCreated(RestaurantMother.AJANTA_RESTAURANT_NAME, RestaurantMother.RESTAURANT_ADDRESS, menu);
  }
