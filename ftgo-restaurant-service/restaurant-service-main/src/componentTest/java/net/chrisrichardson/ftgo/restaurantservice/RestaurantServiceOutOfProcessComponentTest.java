...
public class RestaurantServiceOutOfProcessComponentTest {

    private static final Logger logger = LoggerFactory.getLogger(RestaurantServiceOutOfProcessComponentTest.class);
    private String baseUri;

    static EventuateKafkaNativeCluster eventuateKafkaCluster = new EventuateKafkaNativeCluster("restaurant-service-oop-tests");
