...
public class KitchenService {
  ...
  public Ticket createRestaurantOrder(long restaurantId, Long ticketId, TicketDetails ticketDetails) {
  ...
  public void confirmCreateRestaurantOrder(Long ticketId) {
  ...
  public void cancelCreateRestaurantOrder(Long ticketId) {
    Ticket ro = ticketRepository.findById(ticketId)
            .orElseThrow(() -> new TicketNotFoundException(ticketId));
  ...
  public void cancelRestaurantOrder(long restaurantId, long ticketId) {
    Ticket ticket = ticketRepository.findById(ticketId)
            .orElseThrow(() -> new TicketNotFoundException(ticketId));
  ...
  public void confirmCancelRestaurantOrder(long restaurantId, long ticketId) {
    Ticket ticket = ticketRepository.findById(ticketId)
            .orElseThrow(() -> new TicketNotFoundException(ticketId));
    // TODO - verify restaurant id
  ...
  public void confirmReviseRestaurantOrder(long restaurantId, long ticketId, Map<String, Integer> revisedLineItemQuantities) {
    Ticket ticket = ticketRepository.findById(ticketId)
            .orElseThrow(() -> new TicketNotFoundException(ticketId));
    // TODO - verify restaurant id
    List<TicketDomainEvent> events = ticket.confirmReviseRestaurantOrder(revisedLineItemQuantities);
    domainEventPublisher.publish(ticket, events);
  }
