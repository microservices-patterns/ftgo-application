...
import net.chrisrichardson.ftgo.restaurantorderservice.messagehandlers.KitchenServiceMessageHandlersConfiguration;
import net.chrisrichardson.ftgo.restaurantorderservice.web.KitchenServiceWebConfiguration;
...
@SpringBootTest(classes = TicketServiceInMemoryIntegrationTest.TestConfiguration.class,
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class TicketServiceInMemoryIntegrationTest {
